...
<main id="content" class="site-main">
         ...
         <div class="section-heading text-center">
            <div class="row">
               <div class="col-lg-8 offset-lg-2">
                  ...
                  <h2 class="headingshadow" style="font-size: 40px;"><img src="./assets/images/owl.png" width="50px" />TOP NOTCH DESTINATION <img src="./assets/images/owl.png" width="50px" /></h2>
   ...
   <!-- frontpackages.php -->
   <?php include("./front-packages.php") ?>
   <!-- packages html end -->
